...
定义 @Deprecated 时使用了 @Documented ， 则任何元素使用@Deprecated修饰时， 在生成API文档时， 将会包含 @Deprecated 的说明以下是String的一个过时的构造方法：
...
![image-20211106103012989](%E6%B3%A8%E8%A7%A3.assets/image-20211106103012989.png)
